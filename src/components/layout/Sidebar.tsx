...
const STATIC_SETUP_ROUTES: Array<[string, string]> = [
  ...
  ['/configuration/users/menuaccess', 'menu-access'],
  ['/configuration/users/menu-rights', 'menu-access'],
  ['/configuration/users/menurights', 'menu-access'],
  ...
  ['/configuration/enterprise', 'enterprise-configuration'],
  ['/configuration/enterprise-controls', 'enterprise-controls'],
  ['/configuration/enterprise-controls/enterprise-configuration', 'enterprise-configuration'],
  ['/configuration/enterprise-controls/fiscal-years', 'fiscal-years'],
  ['/configuration/enterprise-controls/fiscal-periods', 'fiscal-periods'],
  ['/configuration/enterprise-controls/financial-dimensions', 'financial-dimensions'],
  ['/configuration/enterprise-controls/dimension-values', 'dimension-values'],
  ['/configuration/enterprise-controls/grants-and-donors', 'grants-and-donors'],
  ['/configuration/enterprise-controls/donors', 'donors'],
  ['/configuration/enterprise-controls/grants', 'grants'],
  ['/configuration/enterprise-controls/tax-rate-versions', 'tax-rate-versions'],
  ['/configuration/enterprise-controls/currency-rates', 'currency-rates'],
  ['/configuration/enterprise-controls/allocation-keys', 'allocation-keys'],
  ['/configuration/enterprise-controls/allocation-key-lines', 'allocation-key-lines'],
  ['/configuration/enterprise-controls/report-templates', 'report-templates'],
  ['/configuration/enterprise-controls/audit-policies', 'audit-policies'],
  ['/configuration/enterprise-controls/dashboard-templates', 'dashboard-templates'],
  ['/configuration/enterprise-controls/notification-rules', 'notification-rules'],
];
...
function getSecondaryMenuIcon(caption: string, hasChildren: boolean, href = ''): PhosphorIcon {
  ...
  if (key.includes('poselectospurchorder') || key.includes('poheader') || key.includes('poselectpurchorder')) return ShoppingCart;
  ...
  if (key.includes('agedsuppliers') || key.includes('priorsupplierbalances')) return CalendarDots;
  if (key.includes('paymentrun')) return MoneyWavy;
  if (key.includes('remittances')) return Receipt;
  if (key.includes('outstandinggrns')) return FileText;
  if (key.includes('supplierdailytransactions')) return CalendarBlank;
  if (key.includes('factorcompanies')) return Buildings;
