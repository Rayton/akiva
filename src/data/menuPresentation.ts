const MENU_DISPLAY_LABELS: Record<string, string> = {
  poselectospurchorder: 'Purchase Orders',
  poheader: 'New PO',
  offersreceived: 'Tenders',
  poauthorisemyorders: 'Authorise POs',
  shiptselect: 'Select Shipment',
  poselectpurchorder: 'PO Inquiry',
  poreport: 'PO Detail/Summary',
  selectsupplier: 'Select Supplier',
  supplierselect: 'Select Supplier',
  supplierallocations: 'Allocations',
  supplierallocatedinquiry: 'Allocated Inquiry',
  agedsuppliers: 'Aged Suppliers',
  supppaymentrun: 'Payment Run',
  paymentrun: 'Payment Run',
  pdfremittanceadvice: 'Remittances',
  remittances: 'Remittances',
  outstandinggrns: 'Outstanding GRNs',
  supplierbalsatperiodend: 'Prior Balances',
  priorsupplierbalances: 'Prior Balances',
  pdfsupptranslisting: 'Daily Txns',
  supplierdailytransactions: 'Daily Txns',
  suppliertransinquiry: 'Supplier Txns',
  suppliertransactions: 'Supplier Txns',
  suppliers: 'Add Supplier',
  addsupplier: 'Add Supplier',
  suppliermaintenance: 'Suppliers',
  factors: 'Factor Companies',
  factorcompanies: 'Factor Companies',
